/* eslint-disable */
/*
create table account(id uuid PRIMARY KEY DEFAULT uuid_generate_v4(), email varchar(75) NOT null UNIQUE, first_name varchar(50), last_name varchar(50), display_name varchar(100) NOT NULL, city varchar(100), country varchar(2), rating int, trade_notes varchar(500));
