/* eslint-disable */
/*
create table account(id uuid PRIMARY KEY DEFAULT uuid_generate_v4(), email varchar(75), first_name varchar(50), last_name varchar(50), username varchar(75) NOT NULL, city varchar(100), country varchar(2), rating int, trade_notes varchar(500));
